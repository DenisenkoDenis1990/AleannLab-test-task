...
export const Paginator = () => {
  return (
    <div className="flex justify-center items-center bg-white rounded-lg">
      ...
      <ul className="flex before:content-[''] before:h-[24px] before:border-r-[1px] before:border-[#38415D]/[0.0513276 before:mr-[42px] before:mt-[8px] after:content-[''] after:h-[24px]  after:border-l-[1px] after:border-[#38415D]/[0.0513276 after:ml-[42px] after:mt-[8px]">
